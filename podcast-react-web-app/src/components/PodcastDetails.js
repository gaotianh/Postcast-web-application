...
const PodcastDetails = () => {
        ...
        const createReviewHandler = async () => {
            ...
            updatedUser.reviews = [...updatedUser.reviews, {_id: review[0]._id}]
            console.log(updatedUser);
        ...
        return (
            <>
                <div className={"container col-9 mt-4"}>
                    <div className={"row"}>
                        <div className={"col-sm"}>
                            <img src={podcastDetails.imageUrl} alt={"Podcast Image"} height={350}/></div>
                        <div className={"col-sm"}>
                    ...
                    <SecureContent>
                        ...
                        <div className={"d-flex "}>
                            <button className={`btn btn-outline-primary me-2 mt-4`}
